 ...
 */
static int32_t cmac_multiply_by_u( unsigned char *output,
 ...
 */
static int32_t cmac_generate_subkeys( mbedtls_cipher_context_t *ctx,
...
int32_t mbedtls_cipher_cmac_starts( mbedtls_cipher_context_t *ctx,
...
int32_t mbedtls_cipher_cmac_update( mbedtls_cipher_context_t *ctx,
...
int32_t mbedtls_cipher_cmac_finish( mbedtls_cipher_context_t *ctx,
...
int32_t mbedtls_cipher_cmac_reset( mbedtls_cipher_context_t *ctx )
{
    mbedtls_cmac_context_t* cmac_ctx;
...
int32_t mbedtls_cipher_cmac( const mbedtls_cipher_info_t *cipher_info,
 ...
 */
int32_t mbedtls_aes_cmac_prf_128( const unsigned char *key, size_t key_length,
...
static const  uint32_t  aes_message_lengths[NB_CMAC_TESTS_PER_KEY] = {
    0,
    16,
    40,
    64
...
static const uint32_t des3_message_lengths[NB_CMAC_TESTS_PER_KEY] = {
    0,
    8,
    20,
    32
...
static int32_t cmac_test_subkeys( int32_t verbose,
                              const char* testname,
...
static int32_t cmac_test_wth_cipher( int32_t verbose,
                                 const char* testname,
                                 const unsigned char* key,
                                 int32_t keybits,
                                 const unsigned char* messages,
                                 const uint32_t message_lengths[4],
...
#if defined(MBEDTLS_AES_C)
static int32_t test_aes128_cmac_prf( int32_t verbose )
{
    int32_t i;
    int32_t ret;
...
int32_t mbedtls_cmac_self_test( int32_t verbose )
{
    int32_t ret;
